...
<form class="row g-3 needs-validation" novalidate @submit.prevent="save">
    ...
    <div class=" flex-wrap justify-content-between">
        ...
        <label for="name" class="col-sm-2 col-form-label">custom</label>
        <div class="col-sm-10 ">
          <input
            type="text"
            class="form-control"
        ...
        <label for="name" class="col-sm-2 col-form-label">Created at</label>
        <div class="col-sm-10 ">
          <input
          readonly
            type="text"
            ...
            v-model="editingProduct.created_at"
          />
        </div>
        ...
        <div class="col-sm-10 ">
          ...
          readonly
            ...
            v-model="editingProduct.updated_at"
          />
        </div>
          <label for="deleted_at" class="col-sm-2 col-form-label">Created at</label>
        <div class="col-sm-10 ">
          <input
          readonly
            type="text"
            ...
            v-model="editingProduct.deleted_at"
          />
        </div>
